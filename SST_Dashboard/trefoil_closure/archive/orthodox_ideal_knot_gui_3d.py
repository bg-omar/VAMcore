...
class Preview3DWidget(QWidget):
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self.mode_combo.addItems(["Centerline", "Curvature", "Tangent quivers"])
        controls.addWidget(self.mode_combo)
        controls.addWidget(QLabel("Preview points / component"))
        self.points_spin = QSpinBox()
        self.points_spin.setRange(150, 5000)
        self.points_spin.setValue(DEFAULT_PREVIEW_POINTS)
    ...
    def render(self):
        ...
        previews = build_preview_data(entry, int(self.points_spin.value()))
...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.preview_tab.points_spin.valueChanged.connect(self.refresh_preview)
