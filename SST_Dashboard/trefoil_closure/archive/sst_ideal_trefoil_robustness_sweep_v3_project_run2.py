...
def main() -> None:
    ...
    print(f"Ideal source     : {IDEAL_SOURCE_DESC}")
    print(f"Local sst_core   : {_SST_CORE_AVAILABLE}")
    ...
    csv_path = os.path.join(OUTPUT_DIR, f"robustness_summary_v3_{args.mode}.csv")
