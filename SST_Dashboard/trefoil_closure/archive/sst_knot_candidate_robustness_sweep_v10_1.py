...
OUTPUT_DIR = os.path.abspath(os.path.join(SCRIPT_DIR, "sst_knot_candidate_robustness_outputs_v10_1"))
...
def write_run_metadata(outdir: str, mode: str, backend_mode: str, backend_used: str,
    ...
    path = os.path.join(outdir, "run_metadata_v10_1.json")
...
def run_single_knot_sweep(args: argparse.Namespace, mode: str, knot_id: str, output_dir: str, run_start_wall: float, base_output_dir: str) -> Dict[str, object]:
    ...
    print("[META] run_metadata_v10_1.json : {}".format(os.path.join(OUTPUT_DIR, "run_metadata_v10_1.json")))
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="", help="Output directory (default: .../sst_knot_candidate_robustness_outputs_v10_1)")
    ...
    try:
        ...
        print("[META] v10.1 knot batch = {}".format(knot_ids))
