...
void bind_gravity_timefield(py::module_& m) {
        m.def("compute_gravitational_potential", &sst::GravityTimeField::compute_gravitational_potential,
		  py::arg("positions"), py::arg("vorticity"), py::arg("epsilon") = 0.1,
		  R"pbdoc(
            Compute Æther gravitational potential field from vorticity.
        )pbdoc");

        m.def("compute_time_dilation_map", &sst::GravityTimeField::compute_time_dilation_map,
